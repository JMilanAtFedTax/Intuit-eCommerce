...
controllersModule.controller('ShoppingCartCtrl', ['$scope', 'ModelSvc', 'CustomerSvc', 'ShoppingCartSvc', 'OrderSvc', 'DeepLinkSvc', 'TrackingSvc',
    function ($scope, ModelSvc, CustomerSvc, ShoppingCartSvc, OrderSvc, DeepLinkSvc, TrackingSvc) {
        //var customer = ModelSvc.model.company.customers[0];
        var customer = ModelSvc.model.customer;
